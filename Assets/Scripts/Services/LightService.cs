...
using UnityEngine;
    public class LightService : MonoBehaviour {
        ...
        public void Init(int[,] _tilesWorldMap, float[,] _tilesLightMap, int[,] _wallTilesMap, float[,] _tilesShadowMap, CycleDay _cycleDay) {
        ...
        public void RecursivAddNewLight(int x, int y, float lastLight, float[,] tilesLightMap) {
            ...
            SetTilemapOpacity(tilesShadowMap, tilesLightMap, x, y);
        ...
        public void SetTilemapOpacity(float[,] tilesShadowMap, float[,] tilesLightMap, int x, int y) {
